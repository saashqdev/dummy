  ...
  return (
    <Menu as="div" className={clsx(className, "relative inline-block text-left")}>
        ...
        <Menu.Button
          ...
          className={clsx(
            ...
            disabled || isLoading
              ...
              : clsx("bg-background", "focus:outline-none focus:ring-2 focus:ring-foreground focus:ring-offset-2")
          )}
        >
          {button}
          {!btnClassName && (
      ...
      >
        <Menu.Items
          className={clsx(
            "absolute z-40 mt-2 w-48 overflow-hidden rounded-md border bg-background shadow-lg ring-1 ring-foreground/50 focus:outline-none",
