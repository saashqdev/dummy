          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="sm:align-center space-y-4 sm:flex sm:flex-col">
              <div className="prose mx-auto text-muted-foreground dark:prose-dark">
                <h1 className="flex justify-center text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">
                  {t('front.privacy.title')}
                </h1>

                <p>
                  Your privacy is important to us. It is inTake&#39; policy to respect your privacy
                  ...
                  <a href="https://intake.dev">https://intake.dev</a>, and other sites we own and
                  operate.
                </p>
                <p>
                  This policy is effective as of 14 December 2021 and was last updated on 14
                  December 2021.
                </p>
                <h3>Information We Collect</h3>
                <p>
                  Information we collect includes both information you knowingly and actively
                  provide us when using or participating in any of our services and promotions, and
                  any information automatically sent by your devices in the course of accessing our
                ...
                <p>
                  ...
                  us, we advise that no method of electronic transmission or storage is 100% secure,
                  and no one can guarantee absolute data security. We will comply with laws
                ...
                <p>
                  ...
                  of 13, and we do not knowingly collect personal information about children under
                  13.
                </p>
                ...
                <p>
                  ...
                  initially provided the information. If we transfer your personal information to
                  third parties in other countries: (i) we will perform those transfers in
                  accordance with the requirements of applicable law; and (ii) we will protect the
                ...
                <p>
                  ...
                  will collect, hold, use and disclose it in accordance with this privacy policy.
                  You retain the right to request details of any personal information we hold about
                  you.
                </p>
                <p>
                ...
                <p>
                  ...
                  and respond to you, in writing, setting out the outcome of our investigation and
                  the steps we will take to deal with your complaint. You also have the right to
                  contact a regulatory body or data protection authority in relation to your
                  complaint.
                </p>
