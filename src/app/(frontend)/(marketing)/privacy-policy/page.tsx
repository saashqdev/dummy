          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="sm:align-center space-y-4 sm:flex sm:flex-col">
              <div className="prose mx-auto text-muted-foreground dark:prose-dark">
                <h1 className="flex justify-center text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">{t("front.privacy.title")}</h1>
                ...
                <p>
                  ...
                  <a href="https://rockstack.dev">https://rockstack.dev</a>, and other sites we own and operate.
                </p>
