      ...
      <div className="mx-auto max-w-7xl px-4 pt-2 sm:px-6 lg:px-8">
        <div className="flex flex-shrink-0 justify-center">
          <div className="mt-4 flex">
            <Link
              href={`/app/${data.currentTenant.slug}/settings/subscription`}
          ...
          <div className="relative mx-auto w-full max-w-7xl space-y-4 overflow-hidden px-2 py-12 sm:py-6">
            ...
            {data?.items && (
              <PlansGrouped
                ...
                currenciesAndPeriod={{
                  currencies: data.currenciesAndPeriod.currencies,
                  billing_periods: data.currenciesAndPeriod.billingPeriods,
                }}
