...
export const actionAdminGeneralSettings = async (
  prev: any,
  form: FormData,
): Promise<ActionData> => {
  ...
  if (action === 'update') {
    ...
    const { storedLogo, storedLogoDarkMode, storedIcon, storedIconDarkMode, storedFavicon } =
      await promiseHash({
        storedLogo: logo
          ? storeSupabaseFile({ bucket: 'branding', content: logo, id: 'logo' })
          : Promise.resolve(''),
        storedLogoDarkMode: logoDarkMode
          ? storeSupabaseFile({ bucket: 'branding', content: logoDarkMode, id: 'logo-dark-mode' })
          : Promise.resolve(''),
        storedIcon: icon
          ? storeSupabaseFile({ bucket: 'branding', content: icon, id: 'icon' })
          : Promise.resolve(''),
        storedIconDarkMode: iconDarkMode
          ? storeSupabaseFile({ bucket: 'branding', content: iconDarkMode, id: 'icon-dark-mode' })
          : Promise.resolve(''),
        storedFavicon: favicon
          ? storeSupabaseFile({ bucket: 'branding', content: favicon, id: 'favicon' })
          : Promise.resolve(''),
      })
    ...
    await updateAppConfiguration({
      name,
      branding_logo: storedLogo,
      branding_logo_dark_mode: storedLogoDarkMode,
      branding_icon: storedIcon,
      branding_icon_dark_mode: storedIconDarkMode,
      branding_favicon: storedFavicon,
      theme,
