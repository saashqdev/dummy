...
function getGreaterThanOrEqualsFromRequest(searchParams?: { [key: string]: string | string[] | undefined }): Date | undefined {
  const countFilter = searchParams?.period ?? defaultPeriodFilter;
