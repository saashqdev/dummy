                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                          <thead className="bg-gray-50">
                            <tr>
                              <th
                                scope="col"
                                className="w-64 select-none truncate px-1 py-1 pl-4 text-left text-xs font-medium tracking-wider text-gray-500"
                              >
                              ...
                              {actions && (
                                <td className="select-none truncate px-1 py-1 text-center text-xs font-medium tracking-wider text-gray-500"></td>
                              )}
                            </tr>
                          </thead>
                              ...
                              return (
                                <tr key={idx}>
                                  ...
                                  {roles.map((role) => {
                                    const existing =
                                      item.roles.find(
                                        (f) => f.role_id === role.id && f.tenant_id === tenantId,
                                      ) !== undefined
                                    return (
                                      <td
                                        key={role.name}
                                        className="whitespace-nowrap px-1 py-1 text-center text-sm text-gray-600"
                                      >
