    ...
    <div className="space-y-5">
      <div className="flex flex-col items-center">
        ...
        <p className="mt-1 text-left">
          <Link
            href={
              appConfiguration.subscription.allow_sign_up_before_subscribe
                ? '/register'
                : '/pricing'
            }
      ...
      <div className="mx-auto flex flex-col items-center space-y-6 rounded-lg border border-border p-6">
        <form action={action} className="w-full space-y-3">
          ...
          <input
            type="hidden"
            name="redirectTo"
            value={redirectTo ?? searchParams.get('redirect') ?? undefined}
          />
          <div>
          ...
          <div className="flex items-center justify-between">
            <Link
              ...
              className="inline-block align-baseline text-xs font-medium text-foreground hover:underline"
            >
