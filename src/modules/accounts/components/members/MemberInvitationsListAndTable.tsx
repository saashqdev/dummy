...
export default function MemberInvitationsListAndTable({
  appUrl,
  items,
  canDelete,
  serverAction,
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center space-x-1 text-gray-500">
                            ...
                            <div
                              className={clsx(
                                (!header.name || sortByColumn !== header.name) && 'invisible',
                              )}
                            >
                              {(() => {
                                if (sortDirection === -1) {
                  ...
                  {items.map((item, idx) => {
                    return (
                      <tr key={idx}>
                        ...
                        <td className="whitespace-nowrap px-2 py-1 text-sm text-gray-600">
                          <a
                            href={getInvitationLink(item)}
                            target="_blank"
                            type="button"
                            rel="noreferrer"
                            className="truncate font-medium italic underline"
                          >
