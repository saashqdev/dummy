...
const WELCOME_EMAIL = {
  ...
  parse: ({
    ...
    const subject = !name
      ? `Welcome to ${appConfiguration.app.name}!`
      : `Welcome to ${appConfiguration.app.name}, ${name}!`
...
${appConfiguration.email.support_email && `<p>If you have any questions, feel free to <a href="mailto:${appConfiguration.email.support_email}">email us</a>.`}

<p>Thanks,
<br>-
<br>${appConfiguration.email.from_name}</p>
`
    return { subject, body }
  },
}
...
<p>If you did not request a password reset, please ignore this email or <a href="mailto:${appConfiguration.email.support_email}">contact support</a> if you have questions.</p>
