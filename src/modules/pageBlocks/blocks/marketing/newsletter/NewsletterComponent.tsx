...
export default function NewsletterComponent() {
  ...
  const [actionResult, setActionResult] = useState<{ error?: string; success?: string } | null>(
    null,
  )
        ...
        <div className="relative mx-auto w-full max-w-xl overflow-hidden px-2 py-12 sm:py-6">
          ...
          <div className="mx-auto mt-12 max-w-xl">
            ...
            >
              ...
              <div className="flex items-baseline justify-between space-x-2 sm:col-span-2">
                ...
                <LoadingButton isLoading={pending} type="submit">
                  {pending
                    ? t('front.newsletter.subscribing') + '...'
            ...
            <div className="mt-2">
              ...
              {actionResult?.error && (
                <ErrorBanner title={t('shared.error')} text={actionResult.error} />
              )}
            </div>
          </div>
        </div>
