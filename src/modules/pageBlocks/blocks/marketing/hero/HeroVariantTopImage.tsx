    ...
    <section className="body-font">
      <div className="container mx-auto flex flex-col items-center justify-center px-5 py-16">
        ...
        <div className="w-full text-center lg:w-2/3">
          ...
          {item.heading && (
            <h1 className="title-font mb-4 text-3xl font-bold sm:text-4xl md:text-5xl md:font-extrabold">
              {t(item.heading)}
            </h1>
          )}
          {item.subheading && (
            <p className="mb-8 leading-relaxed text-muted-foreground">{t(item.subheading)}</p>
          )}
